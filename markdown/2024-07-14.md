...
When I create a Markdown (.md) file containing a blog post and place it in the [GitHub repository](https://github.com/MaxGripe/max-gripe-homepage), it is automatically converted to HTML using F# and uploaded to GitHub Pages. GitHub hosting is available for free, so I'm only paying for the domain name.
